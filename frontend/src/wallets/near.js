...
export class Wallet {
  ...
  callMethod = async ({
    ...
    console.log("providers.getTransactionLastResult(outcome)",providers.getTransactionLastResult(outcome));
  ...
  getTransactionResult = async (txhash) => {
    ...
    console.log("providers.getTransactionLastResult(transaction)",providers.getTransactionLastResult(transaction))
